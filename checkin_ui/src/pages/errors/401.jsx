  ...
  return (
    <div className="error-page">
      <div className="error-container">
        ...
        <p className="error-message">Oops! You need to log in to access this page.</p>
        <p className="error-description">Please sign in with your credentials to continue.</p>
